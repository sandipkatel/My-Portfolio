    ...
    <section id="about" className="py-28 max-w-[1200px] mx-auto px-6">
      <div ref={ref}>
        <div className="reveal mb-14">
          ...
          <h2 className="text-[clamp(1.8rem,3.5vw,2.6rem)] font-extrabold tracking-[-0.03em] text-[var(--text-primary)]">The person behind the models</h2>
        </div>

        <div className="grid grid-cols-1 gap-16 items-start lg:grid-cols-[340px_1fr]">
          {/* Photo column */}
          <div className="reveal reveal-delay-1">
            {/* Photo placeholder */}
            <div className="w-full aspect-[4/5] rounded-[12px] relative overflow-hidden flex items-center justify-center bg-[linear-gradient(135deg,#12121e_0%,#1a1a2e_50%,#0f0f18_100%)] border border-[var(--border)]">
              {/* Grid lines for dark aesthetic */}
              <img src="/sandip_katel.jpg" alt="grid" className="absolute inset-0 w-full h-full object-cover" />

              {/* Corner accent */}
              <div className="absolute top-0 left-0 w-[40px] h-[40px] rounded-[12px_0_0_0] border-t-2 border-l-2 border-[var(--accent-violet)]" />
              <div className="absolute bottom-0 right-0 w-[40px] h-[40px] rounded-[0_0_12px_0] border-b-2 border-r-2 border-[var(--accent-violet)]" />
            </div>
          ...
          <div>
            <div className="reveal reveal-delay-2">
              ...
              <div className="flex gap-3 flex-wrap">
                {[
                  ...
                  <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-3 py-1 rounded text-[0.8rem] font-[var(--font-mono)] text-[var(--text-secondary)] bg-transparent transition-all border border-[var(--border)] hover:border-[var(--accent-violet)] hover:text-[var(--accent-violet)]">
            ...
            {/* Quick facts */}
            <div className="reveal reveal-delay-3 mt-10 p-6 rounded-[12px] bg-[var(--bg-card)] border border-[var(--border)]">
