...
export const skills = [
  { cluster: "Languages",            items: ["Python", "JavaScript", "TypeScript", "C", "C++", "Shell"] },
  { cluster: "Frontend",             items: ["React", "Next.js", "Responsive Design" ] },
  { cluster: "Backend",              items: ["FastAPI", "Next.js(API routes)", "Database Design"] },
  { cluster: "Databases",            items: ["PostgreSQL", "Supabase", "SQLite", "MongoDB"] },
  { cluster: "Tools & DevOps",       items: ["Git", "GitHub Actions", "Docker", "CI/CD", "Linux"] },
  { cluster: "AI / ML",              items: ["PyTorch", "scikit-learn", "Hugging Face", "RAG / LangChain"] },
  { cluster: "Research",             items: ["Experiment Design", "Statistical Analysis", "LaTeX"] },
];